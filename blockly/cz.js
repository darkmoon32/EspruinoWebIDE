...
if (window.location.href.indexOf("lang=cz")>=0) {

// This file was automatically generated.  Do not modify.

      'use strict';

      goog.provide('Blockly.Msg.cz');

      goog.require('Blockly.Msg');

      /** @export */ Blockly.Msg.ADD_COMMENT = "Přidej komentář";
      ...
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_MUTATOR_CONTAINER_TITLE = "Keys";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_MUTATOR_ITEM = "Key";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_MUTATOR_TOOLTIP = "Add a key to read";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_TOOLTIP = "Reads the objects property by given key";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_TEXT = "Read object";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY = "Keys";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_NO_KEY = "No key";
      /** @export */ Blockly.Msg.READ_OBJECTS_PROPERTY_VAR = "Read object";
      /** @export */ Blockly.Msg.URL_PARSE_TOOLTIP = "Parse given string. Second param defines if parse it into objects";
      /** @export */ Blockly.Msg.URL_PARSE_HELPURL = "http://www.espruino.com/Reference#l_url_parse";
      /** @export */ Blockly.Msg.URL_PARSE_URL_TEXT = "Parse URL";
      /** @export */ Blockly.Msg.URL_PARSE_QUERY_TEXT = "parse query";
      /** @export */ Blockly.Msg.HTTPSRS_END_TEXT = "HTTP SR END";
      /** @export */ Blockly.Msg.HTTPSRS_END_DATA_TEXT = "data";
      /** @export */ Blockly.Msg.HTTPSRS_END_TOOLTIP = "Close the response to request. Data can be string or empty.";
      /** @export */ Blockly.Msg.HTTPSRS_END_HELPURL = "http://www.espruino.com/Reference#l_httpSRs_end";
      /** @export */ Blockly.Msg.HTTPSRS_WRITEHEAD_TEXT = "HTTP SR writeHead";
      /** @export */ Blockly.Msg.HTTPSRS_WRITEHEAD_CODE = "code";
      /** @export */ Blockly.Msg.HTTPSRS_WRITEHEAD_KEYS = "keys";
      /** @export */ Blockly.Msg.HTTPSRS_WRITEHEAD_VALUES = "values";
      /** @export */ Blockly.Msg.HTTPSRS_WRITEHEAD_TOOLTIP = "Set the response headers";
      /** @export */ Blockly.Msg.HTTPSRS_WRITEHEAD_HELPURL = "http://www.espruino.com/Reference#l_httpSRs_writeHead";
      /** @export */ Blockly.Msg.TEXT_CHAR_CODE_AT_STR = "In text";
      /** @export */ Blockly.Msg.TEXT_CHAR_CODE_AT_POS = "get char code at";
      /** @export */ Blockly.Msg.TEXT_CHAR_CODE_AT_TOOLTIP = "Gets the charcode of char at given position";
      /** @export */ Blockly.Msg.TEXT_CHAR_CODE_AT_HELPURL = "http://www.espruino.com/Reference#l_String_charCodeAt";
      /** @export */ Blockly.Msg.SOCKET_SEND_DATA_DATA = "Send data";
      /** @export */ Blockly.Msg.SOCKET_SEND_DATA_SOCKET = "to socket";
      /** @export */ Blockly.Msg.SOCKET_SEND_DATA_CLOSE_IT = "close it";
      /** @export */ Blockly.Msg.SOCKET_SEND_DATA_TOOLTIP = "Sends data to socket.";
      /** @export */ Blockly.Msg.SOCKET_SEND_DATA_HELPURL = "http://www.espruino.com/Reference#l_Socket_write";
      /** @export */ Blockly.Msg.CREATE_SERVER_SOCKET_ONINCOMING = "Create socket server. Callback onIncoming";
      /** @export */ Blockly.Msg.CREATE_SERVER_SOCKET_PORT = "listen on port";
      /** @export */ Blockly.Msg.CREATE_SERVER_SOCKET_TOOLTIP = "Create TCP server. CB is called like function(c). You need to store socket variable c for future comunication.";
      /** @export */ Blockly.Msg.BIND_SOCKET_SERVER_CALLBACKS_TOOLTIP = "Binds socket's callbacks (onData, onClose) ex.: onData(data), onClose()";
      /** @export */ Blockly.Msg.BIND_SOCKET_SERVER_CALLBACKS_HELPURL = "http://www.espruino.com/Reference#l_Socket_close";
      /** @export */ Blockly.Msg.TEXT_CHAR_FROM_CHARCODE_HELPURL = "http://www.espruino.com/Reference#l_String_fromCharCode";
      /** @export */ Blockly.Msg.TEXT_CHAR_FROM_CHARCODE_TOOLTIP = "Convert ascii value to char";
      /** @export */ Blockly.Msg.TEXT_CHAR_FROM_CHARCODE_CHARCODE = "Char from charcode";
      /** @export */ Blockly.Msg.LCD_INIT_HELPURL = "http://www.espruino.com/HD44780";
      /** @export */ Blockly.Msg.LCD_INIT_TOOLTIP = "Connects espruino to standard LCD display (driver HD44780)";
      /** @export */ Blockly.Msg.LCD_INIT_RS = "LCD display. RS";
      /** @export */ Blockly.Msg.LCD_INIT_RW = "RW";
      /** @export */ Blockly.Msg.LCD_INIT_E = "E";
      ...
      /** @export */ Blockly.Msg.LCD_WRITE_ITEM = "LCD Write. LCD";
      /** @export */ Blockly.Msg.LCD_WRITE_VALUE = "Value";
      /** @export */ Blockly.Msg.LCD_WRITE_TOOLTIP = "Writes custom command to LCD display";
      /** @export */ Blockly.Msg.LCD_WRITE_HELPURL = "https://www.espruino.com/HD44780";
      /** @export */ Blockly.Msg.LCD_CLEAR_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
      /** @export */ Blockly.Msg.LCD_CLEAR_TOOLTIP = "Clears display";
      /** @export */ Blockly.Msg.LCD_CLEAR_DISP = "LCD Clear";
      /** @export */ Blockly.Msg.LCD_PRINT_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
      /** @export */ Blockly.Msg.LCD_PRINT_TOOLTIP = "";
      /** @export */ Blockly.Msg.LCD_PRINT_DISP = "LCD Print text";
      /** @export */ Blockly.Msg.LCD_PRINT_TEXT = "text";
      /** @export */ Blockly.Msg.LCD_SET_CURSOR_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
      /** @export */ Blockly.Msg.LCD_SET_CURSOR_TOOLTIP = "Set cursor";
      /** @export */ Blockly.Msg.LCD_SET_CURSOR_DISP = "LCD set cursor";
      /** @export */ Blockly.Msg.LCD_SET_CURSOR_X = "column";
      /** @export */ Blockly.Msg.LCD_SET_CURSOR_Y = "row";
      /** @export */ Blockly.Msg.LCD_CREATE_CHAR_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
      /** @export */ Blockly.Msg.LCD_CREATE_CHAR_TOOLTIP = "Create's custom character in LCD ram. It requires index (0-7) of character to set and data in array of length eight";
      /** @export */ Blockly.Msg.LCD_CREATE_CHAR_DISP = "LCD create char";
      /** @export */ Blockly.Msg.LCD_CREATE_CHAR_CHAR = "char position";
      /** @export */ Blockly.Msg.LCD_CREATE_CHAR_DATA = "char data";
      /** @export */ Blockly.Msg.SERVO_MOVE_TOOLTIP = "Move servo to position. Position is between 0-1";
      /** @export */ Blockly.Msg.SERVO_MOVE_POSITION = "Position";
      /** @export */ Blockly.Msg.SERVO_MOVE_PIN = "Servo move. Pin";
      /** @export */ Blockly.Msg.RC522_INIT_SPI = "Initialize RC522 module. SPI";
      /** @export */ Blockly.Msg.RC522_INIT_CS = "CS";
      /** @export */ Blockly.Msg.RC522_INIT_TOOLTIP = "Initialize RC522 module. It requires SPI peripheral and CS pin";
      /** @export */ Blockly.Msg.RC522_INIT_HELPUPL = "https://github.com/espruino/EspruinoDocs/blob/master/devices/MFRC522.md";
      /** @export */ Blockly.Msg.SPI_SETUP_HELPUPL = "http://www.espruino.com/Reference#SPI";
      /** @export */ Blockly.Msg.SPI_SETUP_TOOLTIP = "Setup the SPI interface";
      /** @export */ Blockly.Msg.SPI_SETUP_SPI = "Setup SPI";
      /** @export */ Blockly.Msg.SPI_SETUP_MISO = "MISO";
      /** @export */ Blockly.Msg.SPI_SETUP_MOSI = "MOSI";
      /** @export */ Blockly.Msg.SPI_SETUP_SCK = "SCK";
      /** @export */ Blockly.Msg.RC522_FINDCARDS_HELPUPL = "http://www.espruino.com/Reference#SPI";
      /** @export */ Blockly.Msg.RC522_FINDCARDS_TOOLTIP = "Reads card serial number if is detected. It call's the callback like onDone(card)";
      /** @export */ Blockly.Msg.RC522_FINDCARDS_RC522 = "Find cards.";
      /** @export */ Blockly.Msg.RC522_FINDCARDS_CLBK = "callback";
      /** @export */ Blockly.Msg.JSON_STRINGIFY_HELPURL = "http://www.espruino.com/Reference#l_JSON_stringify";
      /** @export */ Blockly.Msg.JSON_STRINGIFY_TOOLTIP = "Creates JSON string from array";
      /** @export */ Blockly.Msg.JSON_STRINGIFY_ARRAY = "JSON stringify";
      /** @export */ Blockly.Msg.JSON_PARSE_STRING = "JSON parse";
      /** @export */ Blockly.Msg.JSON_PARSE_TOOLTIP = "Parses the JSON string to array";
      /** @export */ Blockly.Msg.JSON_PARSE_HELPURL = "http://www.espruino.com/Reference#l_JSON_parse";
      /** @export */ Blockly.Msg.HTTP_GET_HELPURL = "http://www.espruino.com/Reference#l_http_get";
      /** @export */ Blockly.Msg.HTTP_GET_TOOLTIP = "Creates HTTP GET request. When done it calls callback. Ex. cb(res)";
      /** @export */ Blockly.Msg.HTTP_GET_URL = "HTTP GET";
      /** @export */ Blockly.Msg.HTTP_GET_CLBK = "callback";
      /** @export */ Blockly.Msg.SWITCH_IN = "Microswitch. Port";
      /** @export */ Blockly.Msg.SWITCH_TOOLTIP = "Reads current value of microswitch";
      /** @export */ Blockly.Msg.SWITCH_HELPURL = "http://www.espruino.com/Reference#l__global_digitalRead";
      /** @export */ Blockly.Msg.WATCH_SWITCH_IN = "Watch microswitch. Port";
      /** @export */ Blockly.Msg.WATCH_SWITCH_EDGE = "edge";
      /** @export */ Blockly.Msg.WATCH_SWITCH_DEBOUNCE = "debounce";
      /** @export */ Blockly.Msg.WATCH_SWITCH_TOOLTIP = "Sets watch on given port";
      /** @export */ Blockly.Msg.WATCH_SWITCH_HELPURL = "http://www.espruino.com/Reference#l__global_setWatch";
      /** @export */ Blockly.Msg.POTENCIOMETER_IN = "Potenciometer. Port";
      /** @export */ Blockly.Msg.POTENCIOMETER_TOOLTIP = "Reads current value";
      /** @export */ Blockly.Msg.POTENCIOMETER_HELPURL = "http://www.espruino.com/Reference#l__global_analogRead";
      /** @export */ Blockly.Msg.LINEFINDER_IN = "Get linefinder value. Port";
      /** @export */ Blockly.Msg.LINEFINDER_TOOLTIP = "Reads value from linefinder"
      /** @export */ Blockly.Msg.LINE_SENSOR_3DIODES_A_PORT = "Analog line-sensor 3 diodes. Input port: "
      /** @export */ Blockly.Msg.LINE_SENSOR_3DIODES_A_TOOLTIP = "Read value from a line sensor with 3 diodes in analog mode"
      /** @export */ Blockly.Msg.LINE_SENSOR_3DIODES_D_PORT = "Digital line-sensor 3 diodes. Input port: "
      /** @export */ Blockly.Msg.LINE_SENSOR_3DIODES_D_TOOLTIP = "Read value from a line sensor with 3 diodes in digital mode"
      /** @export */ Blockly.Msg.HCSR04_IN = "Ultrasonic HCSR-04. Port";
      /** @export */ Blockly.Msg.HCSR04_CLBK = "callback";
      /** @export */ Blockly.Msg.HCSR04_TOOLTIP = "Defines connection for HC-SR04 sensor. Callback clbk(distance)";
      /** @export */ Blockly.Msg.HCSR04_HELPURL = "http://www.espruino.com/HC-SR04";
      /** @export */ Blockly.Msg.MOTOR_DRIVER_IN = "Motor. Port";
      /** @export */ Blockly.Msg.MOTOR_DRIVER_SPEED = "speed";
      /** @export */ Blockly.Msg.MOTOR_DRIVER_DIRECTION = "direction";
      /** @export */ Blockly.Msg.MOTOR_DRIVER_TOOLTIP = "Controls connected motors";
      /** @export */ Blockly.Msg.ENCODER_CONNECT_IN = "Initialize encoder. Port";
      /** @export */ Blockly.Msg.ENCODER_CONNECT_HOLES = "count of holes";
      /** @export */ Blockly.Msg.ENCODER_CONNECT_TOOLTIP = "Create instance of encoder sensor counting number of rounds by given number of holes";
      /** @export */ Blockly.Msg.ENCODER_CONNECT_HELPURL = "http://www.espruino.com/Encoder";
      /** @export */ Blockly.Msg.ENCODER_RESET_VAR = "Reset encoder";
      /** @export */ Blockly.Msg.ENCODER_RESET_TOOLTIP = "Clears current encoder value";
      /** @export */ Blockly.Msg.ENCODER_GET_VAR = "Encode";
      /** @export */ Blockly.Msg.ENCODER_GET_FUNCTION = "get property";
      /** @export */ Blockly.Msg.ENCODER_GET_FUNCTION_ROUNDS = "rounds";
      /** @export */ Blockly.Msg.ENCODER_GET_FUNCTION_ANGLE = "angle";
      /** @export */ Blockly.Msg.ENCODER_GET_FUNCTION_STEPS = "steps";
      /** @export */ Blockly.Msg.ENCODER_GET_TOOLTIP = "Reads property from encoder";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_SSID = "Create AP";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_PASSWORD = "password";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_CHANNEL = "channel";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_ENCODING = "encoding";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_CB = "callback";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_TOOLTIP = "Created access point using ESP8266";
      /** @export */ Blockly.Msg.WIFI_CREATEAP_HELPURL = "http://www.espruino.com/modules/ESP8266WiFi_0v25.js";
