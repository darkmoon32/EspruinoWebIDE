...
Blockly.Msg.READ_OBJECTS_PROPERTY_MUTATOR_CONTAINER_TITLE = "Keys";
Blockly.Msg.READ_OBJECTS_PROPERTY_MUTATOR_ITEM = "Key";
Blockly.Msg.READ_OBJECTS_PROPERTY_MUTATOR_TOOLTIP = "Add a key to read";
Blockly.Msg.READ_OBJECTS_PROPERTY_TOOLTIP = "Reads the objects property by given key";
Blockly.Msg.READ_OBJECTS_PROPERTY_TEXT = "Read object";
Blockly.Msg.READ_OBJECTS_PROPERTY = "Keys";
Blockly.Msg.READ_OBJECTS_PROPERTY_NO_KEY = "No key";
Blockly.Msg.READ_OBJECTS_PROPERTY_VAR = "Read object";
Blockly.Msg.URL_PARSE_TOOLTIP = "Parse given string. Second param defines if parse it into objects";
Blockly.Msg.URL_PARSE_HELPURL = "http://www.espruino.com/Reference#l_url_parse";
Blockly.Msg.URL_PARSE_URL_TEXT = "Parse URL";
Blockly.Msg.URL_PARSE_QUERY_TEXT = "parse query";
Blockly.Msg.HTTPSRS_END_TEXT = "HTTP SR END";
Blockly.Msg.HTTPSRS_END_DATA_TEXT = "data";
Blockly.Msg.HTTPSRS_END_TOOLTIP = "Close the response to request. Data can be string or empty.";
Blockly.Msg.HTTPSRS_END_HELPURL = "http://www.espruino.com/Reference#l_httpSRs_end";
Blockly.Msg.HTTPSRS_WRITEHEAD_TEXT = "HTTP SR writeHead";
Blockly.Msg.HTTPSRS_WRITEHEAD_CODE = "code";
Blockly.Msg.HTTPSRS_WRITEHEAD_KEYS = "keys";
Blockly.Msg.HTTPSRS_WRITEHEAD_VALUES = "values";
Blockly.Msg.HTTPSRS_WRITEHEAD_TOOLTIP = "Set the response headers";
Blockly.Msg.HTTPSRS_WRITEHEAD_HELPURL = "http://www.espruino.com/Reference#l_httpSRs_writeHead";
Blockly.Msg.TEXT_CHAR_CODE_AT_STR = "In text";
Blockly.Msg.TEXT_CHAR_CODE_AT_POS = "get char code at";
Blockly.Msg.TEXT_CHAR_CODE_AT_TOOLTIP = "Gets the charcode of char at given position";
Blockly.Msg.TEXT_CHAR_CODE_AT_HELPURL = "http://www.espruino.com/Reference#l_String_charCodeAt";
Blockly.Msg.SOCKET_SEND_DATA_DATA = "Send data";
Blockly.Msg.SOCKET_SEND_DATA_SOCKET = "to socket";
Blockly.Msg.SOCKET_SEND_DATA_CLOSE_IT = "close it";
Blockly.Msg.SOCKET_SEND_DATA_TOOLTIP = "Sends data to socket.";
Blockly.Msg.SOCKET_SEND_DATA_HELPURL = "http://www.espruino.com/Reference#l_Socket_write";
Blockly.Msg.CREATE_SERVER_SOCKET_ONINCOMING = "Create socket server. Callback onIncoming";
Blockly.Msg.CREATE_SERVER_SOCKET_PORT = "listen on port";
...
Blockly.Msg.LCD_INIT_HELPURL = "http://www.espruino.com/HD44780";
Blockly.Msg.LCD_INIT_TOOLTIP = "Connects espruino to standard LCD display (driver HD44780)";
Blockly.Msg.LCD_INIT_RS = "LCD display. RS";
Blockly.Msg.LCD_INIT_RW = "RW";
Blockly.Msg.LCD_INIT_E = "E";
Blockly.Msg.LCD_INIT_D4 = "D4";
Blockly.Msg.LCD_INIT_D5 = "D5";
Blockly.Msg.LCD_INIT_D6 = "D6";
Blockly.Msg.LCD_INIT_D7 = "D7";
Blockly.Msg.LCD_WRITE_ITEM = "LCD Write. LCD";
Blockly.Msg.LCD_WRITE_VALUE = "Value";
Blockly.Msg.LCD_WRITE_TOOLTIP = "Writes custom command to LCD display";
Blockly.Msg.LCD_WRITE_HELPURL = "https://www.espruino.com/HD44780";
Blockly.Msg.LCD_CLEAR_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
Blockly.Msg.LCD_CLEAR_TOOLTIP = "Clears display";
Blockly.Msg.LCD_CLEAR_DISP = "LCD Clear";
Blockly.Msg.LCD_PRINT_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
Blockly.Msg.LCD_PRINT_TOOLTIP = "";
Blockly.Msg.LCD_PRINT_DISP = "LCD Print text";
Blockly.Msg.LCD_PRINT_TEXT = "text";
Blockly.Msg.LCD_SET_CURSOR_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
Blockly.Msg.LCD_SET_CURSOR_TOOLTIP = "Set cursor";
Blockly.Msg.LCD_SET_CURSOR_DISP = "LCD set cursor";
Blockly.Msg.LCD_SET_CURSOR_X = "column";
Blockly.Msg.LCD_SET_CURSOR_Y = "row";
Blockly.Msg.LCD_CREATE_CHAR_HELPURL = Blockly.Msg.LCD_INIT_HELPURL;
Blockly.Msg.LCD_CREATE_CHAR_TOOLTIP = "Create's custom character in LCD ram. It requires index (0-7) of character to set and data in array of length eight";
...
Blockly.Msg.RC522_INIT_SPI = "Initialize RC522 module. SPI";
Blockly.Msg.RC522_INIT_CS = "CS";
Blockly.Msg.RC522_INIT_TOOLTIP = "Initialize RC522 module. It requires SPI peripheral and CS pin";
Blockly.Msg.RC522_INIT_HELPUPL = "https://github.com/espruino/EspruinoDocs/blob/master/devices/MFRC522.md";
Blockly.Msg.SPI_SETUP_HELPUPL = "http://www.espruino.com/Reference#SPI";
Blockly.Msg.SPI_SETUP_TOOLTIP = "Setup the SPI interface";
Blockly.Msg.SPI_SETUP_SPI = "Setup SPI";
Blockly.Msg.SPI_SETUP_MISO = "MISO";
Blockly.Msg.SPI_SETUP_MOSI = "MOSI";
Blockly.Msg.SPI_SETUP_SCK = "SCK";
Blockly.Msg.RC522_FINDCARDS_HELPUPL = "http://www.espruino.com/Reference#SPI";
Blockly.Msg.RC522_FINDCARDS_TOOLTIP = "Reads card serial number if is detected. It call's the callback like onDone(card)";
Blockly.Msg.RC522_FINDCARDS_RC522 = "Find cards.";
Blockly.Msg.RC522_FINDCARDS_CLBK = "callback";
Blockly.Msg.JSON_STRINGIFY_HELPURL = "http://www.espruino.com/Reference#l_JSON_stringify";
Blockly.Msg.JSON_STRINGIFY_TOOLTIP = "Creates JSON string from array";
Blockly.Msg.JSON_STRINGIFY_ARRAY = "JSON stringify";
...
Blockly.Msg.SWITCH_IN = "Microswitch. Port";
Blockly.Msg.SWITCH_TOOLTIP = "Reads current value of microswitch";
Blockly.Msg.SWITCH_HELPURL = "http://www.espruino.com/Reference#l__global_digitalRead";
Blockly.Msg.WATCH_SWITCH_IN = "Watch microswitch. Port";
Blockly.Msg.WATCH_SWITCH_EDGE = "edge";
Blockly.Msg.WATCH_SWITCH_DEBOUNCE = "debounce";
Blockly.Msg.WATCH_SWITCH_TOOLTIP = "Sets watch on given port";
Blockly.Msg.WATCH_SWITCH_HELPURL = "http://www.espruino.com/Reference#l__global_setWatch";
Blockly.Msg.POTENCIOMETER_IN = "Potenciometer. Port";
Blockly.Msg.POTENCIOMETER_TOOLTIP = "Reads current value";
Blockly.Msg.POTENCIOMETER_HELPURL = "http://www.espruino.com/Reference#l__global_analogRead";
Blockly.Msg.LINEFINDER_IN = "Get linefinder value. Port";
Blockly.Msg.LINEFINDER_TOOLTIP = "Reads value from linefinder"
Blockly.Msg.LINE_SENSOR_3DIODES_A_PORT = "Analog line-sensor 3 diodes. Input port: "
Blockly.Msg.LINE_SENSOR_3DIODES_A_TOOLTIP = "Read value from a line sensor with 3 diodes in analog mode"
Blockly.Msg.LINE_SENSOR_3DIODES_D_PORT = "Digital line-sensor 3 diodes. Input port: "
Blockly.Msg.LINE_SENSOR_3DIODES_D_TOOLTIP = "Read value from a line sensor with 3 diodes in digital mode"
Blockly.Msg.HCSR04_IN = "Ultrasonic HCSR-04. Port";
Blockly.Msg.HCSR04_CLBK = "callback";
Blockly.Msg.HCSR04_TOOLTIP = "Defines connection for HC-SR04 sensor. Callback clbk(distance)";
Blockly.Msg.HCSR04_HELPURL = "http://www.espruino.com/HC-SR04";
Blockly.Msg.MOTOR_DRIVER_IN = "Motor. Port";
Blockly.Msg.MOTOR_DRIVER_SPEED = "speed";
Blockly.Msg.MOTOR_DRIVER_DIRECTION = "direction";
Blockly.Msg.MOTOR_DRIVER_TOOLTIP = "Controls connected motors";
Blockly.Msg.ENCODER_CONNECT_IN = "Initialize encoder. Port";
Blockly.Msg.ENCODER_CONNECT_HOLES = "count of holes";
Blockly.Msg.ENCODER_CONNECT_TOOLTIP = "Create instance of encoder sensor counting number of rounds by given number of holes";
Blockly.Msg.ENCODER_CONNECT_HELPURL = "http://www.espruino.com/Encoder";
Blockly.Msg.ENCODER_RESET_VAR = "Reset encoder";
Blockly.Msg.ENCODER_RESET_TOOLTIP = "Clears current encoder value";
Blockly.Msg.ENCODER_GET_VAR = "Encode";
Blockly.Msg.ENCODER_GET_FUNCTION = "get property";
Blockly.Msg.ENCODER_GET_FUNCTION_ROUNDS = "rounds";
Blockly.Msg.ENCODER_GET_FUNCTION_ANGLE = "angle";
Blockly.Msg.ENCODER_GET_FUNCTION_STEPS = "steps";
Blockly.Msg.ENCODER_GET_TOOLTIP = "Reads property from encoder";
Blockly.Msg.WIFI_CREATEAP_SSID = "Create AP";
Blockly.Msg.WIFI_CREATEAP_PASSWORD = "password";
Blockly.Msg.WIFI_CREATEAP_CHANNEL = "channel";
Blockly.Msg.WIFI_CREATEAP_ENCODING = "encoding";
Blockly.Msg.WIFI_CREATEAP_CB = "callback";
Blockly.Msg.WIFI_CREATEAP_TOOLTIP = "Created access point using ESP8266";
Blockly.Msg.WIFI_CREATEAP_HELPURL = "http://www.espruino.com/modules/ESP8266WiFi_0v25.js";
Blockly.Msg.WIFI_GET_CONNECTED_DEVICES_CB = "Get connected devices";
Blockly.Msg.WIFI_GET_CONNECTED_DEVICES_TOOLTIP = "Get list of connected devices. callback(err,devices)";
Blockly.Msg.WIFI_GET_CONNECTED_DEVICES_HELPURL = "http://www.espruino.com/modules/ESP8266WiFi_0v25.js";
