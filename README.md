...
* Install the [Chrome Web Browser](https://www.google.com/intl/en/chrome/browser/)
* Download the files in [EspruinoWebIDE](http://gitlab.fai.utb.cz/jurenat/EspruinoWebIDE) to an `EspruinoWebIDE` directory on your PC (either as a [ZIP File](http://gitlab.fai.utb.cz/jurenat/EspruinoWebIDE/repository/archive.zip?ref=master), or using git)
* Download the files in [EspruinoTools](https://github.com/darkmoon32/EspruinoTools) into the `EspruinoWebIDE/EspruinoTools` on your PC (either as a [ZIP File](https://github.com/darkmoon32/EspruinoTools/archive/master.zip), or using git)
